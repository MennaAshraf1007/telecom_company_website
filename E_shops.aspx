...
<br />
        ...
        <asp:Button ID="Backwallets" runat="server" OnClientClick="backwallet" Text="Back_to_Wallets" />
        <asp:Button ID="pay" runat="server" OnClientClick="gotopayments" Text="Display_Payments" />
    </form>
</body>
</html>
